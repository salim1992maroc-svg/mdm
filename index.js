...
.balanceLabel{font-size:16px;letter-spacing:1.7px;color:#9d9abf}.balanceCard .balance{font-size:57px;font-weight:900;line-height:1.05;color:#d36cff;text-shadow:0 0 8px #9f22ff,0 0 24px rgba(168,61,255,.8);margin:18px 0 13px}.gemLabel{font-size:23px;font-weight:900;color:#a85cff;text-shadow:0 0 10px rgba(159,65,255,.55)}
